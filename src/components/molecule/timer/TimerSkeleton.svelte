...
>
  <div class="animate-pulse">
    ...
    <div class="flex flex-row justify-evenly mx-8">
      <div class="h-20 w-20 bg-slate-700 rounded-full" />
      <div class="h-20 w-20 bg-slate-700 rounded-full" />
      <div class="h-20 w-20 bg-slate-700 rounded-full" />
    </div>
    <div class="h-8 bg-slate-700 rounded-md w-auto my-4 mx-8" />
    <div class="h-4 bg-slate-700 rounded-md w-auto my-4 mx-8" />
    <div class="h-4 bg-slate-700 rounded-md w-auto my-4 mx-8" />
  </div>
</div>
