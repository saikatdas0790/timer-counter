...
export default function PeekingControls() {
    ...
    return (
        <div
            className={`fixed z-10 bottom-12 right-0 flex gap-4 bg-slate-700 p-4 rounded-l-2xl transition-transform shadow shadow-fuchsia-400 ${isPeekOpen ? "" : "translate-x-16"
                }`}
        >
            <button
